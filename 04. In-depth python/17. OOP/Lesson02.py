...
class FullTimeEmployee(Employee):
    ...
    def get_unpaid_vacation(self, date: str, unpaid_vacation_days: int):
        return (f'Начало неоплачиваемого отпуска: {date}, '
                f'продолжительность: {unpaid_vacation_days} дней.')
